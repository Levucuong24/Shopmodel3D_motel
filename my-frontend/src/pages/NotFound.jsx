  ...
  return (
    <main className="relative w-full overflow-x-hidden font-sans selection:bg-white/20 selection:text-white">
      ...
      <section className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <motion.div
          className="flex flex-col items-center text-center gap-5 text-white max-w-2xl"
        ...
        >
          ...
          <p
            ...
            style={{
              ...
              textShadow: "0 4px 60px rgba(255,255,255,0.18)",
            }}
          >
            404
          </p>
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-2xl font-light tracking-wide text-white/80 lowercase">
          ...
          <Link
            to="/welcome"
            className="mt-4 px-8 py-3 rounded-full text-sm font-semibold uppercase tracking-widest text-white transition-all duration-300 hover:-translate-y-0.5"
            style={{
      ...
      <section className="relative z-10 w-full px-6 pb-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {["Labs & Workshops", "Deep Dive Series", "Global Circle", "Resource Vault", "Future Roadmap"].map(item => (
                      <li key={item}><a href="#" className="text-xs text-white/55 hover:text-white transition-colors">{item}</a></li>
                    ))}
                  </ul>
                </div>
                <div>
